...
func createSun() -> SCNNode {
        ...
        matrix2 = SCNMatrix4(m11: 2,          m12: 0,     m13: 0,          m14: 0,
        ...
        for i in 1..<13 {   // 12 rays
            ...
            rotation = ((.pi*2))/12*Float(i)+0.17   // addition at the end for symmetry
            ...
            matrix1 = SCNMatrix4Mult(spin90X, matrix1)              // lay ray down then rotate it around the y axis
            rayNode.transform = SCNMatrix4Mult(matrix2, matrix1)    // move ray out to the ede of the sun
            
            sunNode.addChildNode(rayNode)
        }
        
        // orient sun into correct position with respect to the cube
        sunNode.transform = SCNMatrix4Mult(spin90X, spin45Y)
